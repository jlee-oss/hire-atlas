...
- generatedAt: `2026-04-11T14:57:36.466006+00:00`
- items: `25`
- modelDecisions: `{'exclude': 4, 'include': 16, 'review': 5}`
- suggestedDecisions: `{'exclude': 4, 'include': 16, 'review': 5}`
- reviewPriorities: `{'confirm_positive': 16, 'goldset_conflict_review': 4, 'human_boundary_review': 5}`
...
|---:|---|---|---|---|---|---|---|
| 1 | goldset_conflict_review | 슈어소프트테크 | [우주항공국방기술실(판교)] SW검증 (경력) | high | exclude | exclude | 일반 non-scope 가능성이 커 goldset 과포함 여부 확인 |
| 2 | goldset_conflict_review | 아키드로우 | 클라우드 인프라 엔지니어(DevOps) | high | exclude | exclude | 일반 non-scope 가능성이 커 goldset 과포함 여부 확인 |
| 3 | goldset_conflict_review | 여기어때 | Server Engineer [숙박플랫폼개발] | high | exclude | exclude | 일반 non-scope 가능성이 커 goldset 과포함 여부 확인 |
...
|---:|---|---|---|---|---|---|
| 1 | 슈어소프트테크 | [우주항공국방기술실(판교)] SW검증 (경력) | high | exclude | exclude |  |
| 2 | 아키드로우 | 클라우드 인프라 엔지니어(DevOps) | high | exclude | exclude |  |
| 3 | 여기어때 | Server Engineer [숙박플랫폼개발] | high | exclude | exclude |  |
