# Quality Iteration 013

- 상태: `manual_intervention_required`
- 생성 시각: `2026-04-10T08:32:38.751275+00:00`
- optimization score: `89.916`
...
- `releaseCoreFocusExact`: `actual=0.7857` / `target=0.85` / `min` / `pass=False`
