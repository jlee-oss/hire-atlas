# Quality Iteration 031

- 상태: `iteration_limit_reached`
- 생성 시각: `2026-04-11T13:56:50.662092+00:00`
- optimization score: `83.871`
...
- `guardRecoveredRows`: `actual=25.0` / `target=0.0` / `max` / `pass=False`
- `guardRecoveredHighQualityRows`: `actual=18.0` / `target=0.0` / `max` / `pass=False`
