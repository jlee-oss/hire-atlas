# Quality Iteration 005

- 상태: `manual_intervention_required`
- 생성 시각: `2026-04-10T06:46:51.661911+00:00`
- optimization score: `63.2932`
- release champion: `gemma-4-31b / field_aware_v3`

## 핵심 지표

- boardLowRate: `0.256604`
- boardMissingSummaryRows: `58`
- boardExplicitLowRows: `10`
- signalMetaLeakRows: `0`
- mixedClusterRoleLeakRows: `0`
- roleConflictRows: `0`
- roleMissingClassifierRows: `51`
- roleStaleClassifierRows: `212`
...
- `boardMissingSummaryRows`: `actual=58.0` / `target=0.0` / `max` / `pass=False`
...
- `roleMissingClassifierRows`: `actual=51.0` / `target=0.0` / `max` / `pass=False`
- `roleStaleClassifierRows`: `actual=212.0` / `target=0.0` / `max` / `pass=False`
